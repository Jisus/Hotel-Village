...
class ReservasControllerTest < ActionController::TestCase
  ...
  test "should create reserva" do
    assert_difference('Reserva.count') do
      post :create, reserva: { DataEntrada: @reserva.DataEntrada, DataPagamento: @reserva.DataPagamento, DataSaida: @reserva.DataSaida, Pagamento: @reserva.Pagamento }
    end
  ...
  test "should update reserva" do
    put :update, id: @reserva, reserva: { DataEntrada: @reserva.DataEntrada, DataPagamento: @reserva.DataPagamento, DataSaida: @reserva.DataSaida, Pagamento: @reserva.Pagamento }
    assert_redirected_to reserva_path(assigns(:reserva))
  end
