...
class CheckoutsControllerTest < ActionController::TestCase
  ...
  test "should create checkout" do
    assert_difference('Checkout.count') do
      post :create, checkout: { cliente: @checkout.cliente, dataEntrada: @checkout.dataEntrada, dataSaida: @checkout.dataSaida, quarto: @checkout.quarto, tipoPagamento: @checkout.tipoPagamento, valor_total: @checkout.valor_total }
    end
  ...
  test "should update checkout" do
    put :update, id: @checkout, checkout: { cliente: @checkout.cliente, dataEntrada: @checkout.dataEntrada, dataSaida: @checkout.dataSaida, quarto: @checkout.quarto, tipoPagamento: @checkout.tipoPagamento, valor_total: @checkout.valor_total }
    assert_redirected_to checkout_path(assigns(:checkout))
  end
